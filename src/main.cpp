...
// configuration step. It creates a namespace called `aFtuixGame`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        aFtuixGame::cmake::project_name,
        aFtuixGame::cmake::project_version));// version string, acquired
